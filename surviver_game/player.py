...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, groups, HP, SP, AT, catch_range, image, enemy_group):
        super().__init__(groups)
        self.screen = pygame.display.get_surface()
        self.background = pygame.Surface((map_w, map_h))
        self.enemy_group = enemy_group
        self.weapon_manager = WeaponManager(self, enemy_group)
        self.weapon_manager.add_weapon("Waterball", 3000)
        self.weapon_manager.add_weapon("Syuriken", 2000)
        ...
        self.initial_HP = HP
        self.SP = SP
        self.catch_range = catch_range * mapchip_size
        self.image = image
        self.frame = 0
        self.timer = 0
    ...
    def find_nearest_enemy(self):
        ...
        self.nearest_enemy_now = pygame.Vector2(
            self.nearest_enemy.rect.x, self.nearest_enemy.rect.y)
