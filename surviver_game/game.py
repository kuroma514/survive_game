...
class Game:
    ...
    def __init__(self):
        ...
        self.Player = Player(self.player_group, 5, 3, 1, 2,
                             self.player_num, self.enemy_group)
        ...
        for i in range(8):
            self.shortrange_enemy_test = Shortrange(self.enemy_group, 100, 1,
                                                    self.enemy_test_num, self.Player, self.enemy_group, 2*i, 4, 2)
